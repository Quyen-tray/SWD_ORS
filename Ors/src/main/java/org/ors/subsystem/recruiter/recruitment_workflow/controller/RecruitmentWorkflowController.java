...
import org.ors.subsystem.recruiter.recruitment_workflow.service.IRecruitmentWorkflowService;
...
public class RecruitmentWorkflowController {
    ...
    private final IRecruitmentWorkflowService recruitmentWorkflowService;

    public RecruitmentWorkflowController(IRecruitmentWorkflowService recruitmentWorkflowService) {
        this.recruitmentWorkflowService = recruitmentWorkflowService;
    }
